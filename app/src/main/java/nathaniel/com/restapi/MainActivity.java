...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Get the id's of the fields
        etGitHubUser = findViewById(R.id.et_github_user);
        btnGetRepos = findViewById(R.id.btn_get_repos);
        tvRepoList = findViewById(R.id.tv_repo_list);
